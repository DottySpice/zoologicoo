                ...
                <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="../images/safari/safariNav1.jpg" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Experencia automatizada</h5>
                                <p>Recorre todo nuestro reciento de safari en nuestros vehiculos bien equipados para la tarea</p>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="../images/safari/safariNav2.jpg" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Gran experencia</h5>
                                <p>Recore nuestro reciento con sus especiemen en todo su esplendor</p>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img src="../images/safari/safariNav3.jpg" class="d-block w-100" alt="...">
                            <div class="carousel-caption d-none d-md-block">
    ...
    <div class="container p-3">
        <div class="row justify-content-center align-items-center">
            <div class="col-lg-3 shadow m-3">
                <img src="../images/safari/leon1.jpg" class="img-fluid" alt="...">
                <h2>León</h2>
                <p>El león es un mamífero carnívoro de la familia de los félidos y una de las cinco especies del género Panthera</p>
                <p><a class="btn btn-primary" href="#">Ver en el mapa</a></p>
            </div>
            
            <div class="col-lg-3 shadow m-3">
                <img src="../images/safari/elefante.jpg" class="img-fluid" alt="...">
                <h2>Elefante</h2>
                <p>Los elefantes o elefántidos son una familia de mamíferos placentarios del orden Proboscidea. Antiguamente se clasificaban, junto con otros mamíferos de piel gruesa</p>
                <p><a class="btn btn-primary" href="#">Ver en el mapa</a></p>
            </div>

            <div class="col-lg-3 shadow m-3">
                <img src="../images/safari/zebra.jpg" class="img-fluid" alt="...">
                <h2>Cebra</h2>
                <p>Se conocen como cebra​ a tres especies del género Equus propias de África</p>
                <p><a class="btn btn-primary " href="#">Ver en el mapa</a></p>
            </div>
        ...
        <div class="row">
            <div class="col">
                <h2>Jirafa</h2>
                <p>La jirafa es una especie de mamífero artiodáctilo, de la familia Giraffidae propio de África. Es la más alta de todas las especies de animales terrestres existentes.</p>
            </div>

            <div class="col">
                <img src="../images/safari/jirafa1.jpg" class="img-fluid" alt="...">
            </div>
        </div>
    </div>
